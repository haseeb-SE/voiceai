    ...
    return (
        <div className="min-h-screen bg-[#121620] text-white">
                    ...
                    <div className="flex items-center justify-between max-w-6xl mx-auto">
                        <div className="flex items-center gap-4">
                            <div className="relative group">
                                <div className="absolute -inset-1 bg-gradient-to-r from-teal-600 to-teal-400 rounded-full opacity-70 group-hover:opacity-100 blur group-hover:blur-md transition-all duration-500"></div>
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="text-xl font-bold text-teal-500">Downloader</span>
                            </div>
                        </div>
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-8">
                ...
                <div className="flex items-center p-3 bg-gray-800 rounded-lg">
                    <span className="text-teal-400 mr-2">✓</span>
                    <span className="text-sm md:text-base">Convert TikTok Videos to MP4 or MP3</span>
                </div>
                <div className="flex items-center p-3 bg-gray-800 rounded-lg">
                    <span className="text-teal-400 mr-2">✓</span>
