...
async function getDictionary(locale: string): Promise<Dict> {
  try {
    return (await import(`../../../messages/insta-${locale}.json`)).default

  } catch {
    return (await import(`../../../messages/insta-en.json`)).default
  }
}
...
export default async function InstagramPage({ params }: { params: { locale: string } }) {
        ...
        <div className="container mx-auto px-4 md:px-8 max-w-6xl">
          <Card className="border border-gray-700 bg-gray-800/80 text-white shadow-2xl backdrop-blur-sm">
            <CardHeader className="border-b border-gray-700">
              <CardTitle className="text-pink-500 text-2xl md:text-3xl">{dict.downloaderTitle}</CardTitle>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-12">
            <Button className="bg-pink-600 hover:bg-pink-700 text-white text-lg px-8 py-6 rounded-lg shadow-lg hover:shadow-pink-500/30 transition-all duration-300 transform hover:scale-105 group">
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold text-white">
                  <span className="text-pink-500">{dict.downloaderTitle}</span>
                </h3>
              </div>
            ...
            },
            {
              ...
              step: [
                ...
                },
                {
                  ...
                  text: "Select MP4 format and preferpink quality, then hit Download. Your Insta video will be saved in seconds.",
                },
              ],
            },
            {
