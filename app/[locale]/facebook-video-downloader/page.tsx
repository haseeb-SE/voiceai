...
async function getDictionary(locale: string): Promise<Dict> {
  try {
    return (await import(`../../../messages/facebook-${locale}.json`)).default

  } catch {
    return (await import(`../../../messages/facebook-en.json`)).default
  }
}
...
export const metadata: Metadata = {
  ...
  description: "Download Facebook videos quickly and for free. Use the best Facebook video downloader to convert Facebook videos to MP4 without software.",
  keywords:
...
export default async function FacebookPage({ params }: { params: { locale: string } }) {
        ...
        <div className="container mx-auto px-4 md:px-8 max-w-6xl">
          <Card className="border border-gray-700 bg-gray-800/80 text-white shadow-2xl backdrop-blur-sm">
            <CardHeader className="border-b border-gray-700">
              <CardTitle className="text-blue-500 text-2xl md:text-3xl">{dict.downloaderTitle}</CardTitle>
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold text-white">
                  <span className="text-blue-500">{dict.downloaderTitle}</span>
                </h3>
              </div>
