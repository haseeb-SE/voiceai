...
async function getDictionary(locale: string): Promise<Dict> {
  try {
    return (await import(`../../../messages/priv-${locale}.json`)).default
  } catch {
    return (await import(`../../../messages/priv-en.json`)).default
  }
}

export const metadata: Metadata = {
  title: "Privacy Policy – YTMP4 Downloader",
  description:
    "Privacy Policy for youtubetomp4download.com – how we collect, use, and protect your data.",
}
