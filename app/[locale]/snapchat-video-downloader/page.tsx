...
async function getDictionary(locale: string): Promise<Dict> {
    try {
        return (await import(`../../../messages/snapchat-${locale}.json`)).default

    } catch {
        return (await import(`../../../messages/snapchat-en.json`)).default
    }
}
...
export default async function SnapchatPage({ params }: { params: { locale: string } }) {
                ...
                <div className="container mx-auto px-4 md:px-8 max-w-6xl">
                    <Card className="border border-gray-700 bg-gray-800/80 text-white shadow-2xl backdrop-blur-sm">
                        <CardHeader className="border-b border-gray-700">
                            <CardTitle className="text-yellow-500 text-2xl md:text-3xl">{dict.downloaderTitle}</CardTitle>
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                        <div className="relative group">
                            <div className="absolute -inset-0.5 bg-gradient-to-r from-yellow-600 to-yellow-400 rounded-xl opacity-50 group-hover:opacity-100 blur group-hover:blur-md transition-all duration-500"></div>
                    ...
                    <div className="text-center mt-12">
                        <Button className="bg-yellow-600 hover:bg-yellow-700 text-white text-lg px-8 py-6 rounded-lg shadow-lg hover:shadow-yellow-500/30 transition-all duration-300 transform hover:scale-105 group">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        <div>
                            <div className="flex items-center gap-3 mb-4">
                                <div className="h-10 w-10 rounded-full border border-yellow-500 flex items-center justify-center">
                                    <FaSnapchat className="h-6 w-6 text-yellow-500" />
                                </div>
                                <h3 className="text-xl font-bold text-white">
                                    <span className="text-yellow-500">{dict.downloaderTitle}</span>
                                </h3>
                            </div>
